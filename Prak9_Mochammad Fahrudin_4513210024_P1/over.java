...
//menampilkan menu PILIHAN
		...
		switch(Menu){
			case 1 :
				System.out.println("Menu yang Anda Pilih Overloading ");
				System.out.println("Overloading  adalah method dengan nama yang sama dengan method lain pada suatu class tetapi dengan parameter yang berbeda. ");
				System.out.println (" class Pertambahan{ ");
				System.out.println ("public void tambah1(){");
				System.out.println ("int a=10, b=35;");
			...
			case 2: 
				System.out.println("Menu yang Anda Pilih Overriding ");
				System.out.println("Definisi Overridding : ");
					 ...
					 System.out.println("System.out.println(''" + "Mochammad Fahrudin''" + ");");
					 System.out.println(" } ");
					 System.out.println("public static void main(String [] args) { ");
					 ...
					 System.out.println("public void Sapa() {");
					 System.out.println("System.out.println(''" + "Puri Rahmatika''" + ");");
					 System.out.println("}");
					 System.out.println("}");
				break;
				
			default: System.out.print("Menu yang anda  pilih tidak tersedia !!");
		}
	}
}